...
from Fruehstuek_DL_DataPreparation import DataPreparation
...
class TestDataPreparation(unittest.TestCase):
    ...
    def testForSimpleDataframe(self):
        ...
        dataPreparation = DataPreparation('d:/Profiles/fuhlmann/Programmierung/Python/zz_boersendaten/Boersendaten/testCSV.csv')
    ...
    def testForColumnCut(self):
        ...
        DFtoPrepare = DataPreparation(
            'D:/Profiles/fuhlmann/Programmierung/Python/zz_boersendaten/Boersendaten/DAX30_TimeFrameMin_M1_CandleData_TDD_DataFrameMuster.csv')
